...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(313, 51);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Ошибка! Эйлеров путь не может быть найден!\r\nКол-во нечетных верши в графе больше "
				L"2!\r\n(Нажмите OK)";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(421, 109);
			...
			this->ClientSize = System::Drawing::Size(554, 155);
